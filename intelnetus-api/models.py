...
class Publication_Db_Model(db.Model):
    ...
    journal = db.Column(db.String(510))
    abstract = db.Column(db.String(5000))
    keywords = db.Column(db.String(681))
    fields = db.Column(db.String(400))
...
class Author_Db_Model(db.Model):
    ...
    study_fields = db.Column(db.String(5000))
    affiliations = db.Column(db.String(5000))
...
class Organization_Db_Model(db.Model):
    ...
    address = db.Column(db.String(270))
